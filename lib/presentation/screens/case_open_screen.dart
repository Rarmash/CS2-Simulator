...
class _CaseOpenScreenState extends State<CaseOpenScreen> {
  ...
  Widget _buildRoller() {
    ...
    return OpeningRoller<SkinDto>(
      controller: _rollController,
      items: _rollSequence,
      winningIndex: _winningIndex,
      isRolling: _isRolling,
      itemBuilder: (skin, isWinner, itemWidth) =>
          _buildRollItem(skin, isWinner: isWinner, itemWidth: itemWidth),
    );
  }
  ...
  Widget _buildContainerTypeBadge() {
    ...
    return ChipBadge(label: widget.caseDto.typeLabel, color: color);
  }
